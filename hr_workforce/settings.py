"""
Django settings for hr_workforce project.
...
SECRET_KEY = 'django-insecure-n%wc9%qrh)o$kb7=o$q_c(w-yqca%u8jop25q6i0_2hg7_u@jw'
...
ROOT_URLCONF = 'hr_workforce.urls'
...
WSGI_APPLICATION = 'hr_workforce.wsgi.application'
